...
async def help_handler(message: Message):
    await message.answer(
        "🤖 *Помощь по боту*\n\n"
        "Я умею автоматически анализировать сообщения в чате и делать краткую выжимку.\n\n"
        "📌 *Как я работаю:*\n"
        "• После добавления в чат я начинаю парсить сообщения\n"
        "• Учитываю текст, голосовые сообщения и фото\n\n"
        "📝 *Команды:*\n"
        "• /summarize — отправить краткую сводку по чату\n"
        "• /help — показать это сообщение\n\n"
        "🎙 *Поддержка:*\n"
        "• Обычные сообщения \n"
        "• Голосовые сообщения (ГС)\n"
        "• Фото (анализ содержания)\n\n"
        "⚠️ *Важно:*\n"
        "Бот работает только после добавления в чат и при наличии прав на чтение сообщений.",
        parse_mode="Markdown"
    )
